    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_image', models.ImageField(blank=True, default='cover.jpg', null=True, upload_to=Authentication.models.user_directory_path)),
                ('image', models.ImageField(blank=True, default='default.jpg', null=True, upload_to=Authentication.models.user_directory_path)),
                ...
                ('relationship', models.CharField(blank=True, choices=[('single', 'single'), ('married', 'married'), ('divorced', 'divorced')], default='single', max_length=100, null=True)),
                ...
                ('whatsApp', models.CharField(blank=True, default='+44 (707) 234', max_length=100, null=True)),
